		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BTP Logali. DLG06",
									"targetURL": "#Logalisince0project1dlg06-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Logalisince0project1dlg06-display": {
								"semanticObject": "Logalisince0project1dlg06",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Logalisince0.project1dlg06",
									"url": sap.ui.require.toUrl("Logalisince0/project1dlg06")
								}
							}
						}
					}
